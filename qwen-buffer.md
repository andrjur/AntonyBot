На основе предоставленного кода и анализа функционала бота, можно дополнить список команд всеми доступными кнопками и действиями. Вот полный список команд и кнопок, которые реализованы в боте:
